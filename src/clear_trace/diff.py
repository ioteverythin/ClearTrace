...
from clear_trace._types import EventType, Trace
from clear_trace.normalize import normalize_for_comparison
...
class TraceDiff:
    ...
    rag_diff: Any | None = None  # RAGDiffResult from clear_trace.rag.diff

    # Optional semantic diff (populated when semantic=True passed to diff_traces)
    semantic_diff: Any | None = None  # SemanticDiffResult from clear_trace.semantic
...
def diff_traces(
    ...
    *,
    ...
    if rag:
        try:
            from clear_trace.rag.diff import diff_rag
    ...
    if semantic:
        try:
            from clear_trace.semantic.similarity import semantic_similarity
