...
def install_langchain_record_patches(
    ...
    Args:
        recorder: The :class:`~clear_trace.recorder.Recorder` instance.
...
def install_langchain_replay_patches(
    ...
    Args:
        replayer: The :class:`~clear_trace.replayer.Replayer` instance.
...
def _patch_chat_model_invoke(recorder: Any, patches: list[Any]) -> None:
    try:
        ...
        from clear_trace._types import EventType, TraceEvent
        from clear_trace.recorder import _Patch, _response_to_dict, _safe_serialize
...
def _patch_base_tool_invoke(recorder: Any, patches: list[Any]) -> None:
    try:
        ...
        from clear_trace._types import EventType, TraceEvent
        from clear_trace.recorder import _Patch, _safe_serialize
