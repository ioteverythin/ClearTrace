...
from clear_trace.cassette import save_cassette
...
class Recorder:
    ...
    def _try_patch_openai(self) -> None:
        ...
        try:
            ...
            def patched_create(self_inner: Any, *args: Any, **kwargs: Any) -> Any:
                ...
                if is_streaming:
                    from clear_trace.streaming import StreamCapture
    ...
    def _try_patch_openai_async(self) -> None:
        ...
        try:
            ...
            async def patched_create(self_inner: Any, *args: Any, **kwargs: Any) -> Any:
                ...
                if is_streaming:
                    from clear_trace.streaming import AsyncStreamCapture
    ...
    def _try_patch_langchain(self) -> None:
        ...
        try:
            from clear_trace.interceptors.langchain import install_langchain_record_patches
    ...
    def _try_patch_langgraph(self) -> None:
        ...
        try:
            from clear_trace.interceptors.langgraph import install_langgraph_record_patches
    ...
    def _try_patch_crewai(self) -> None:
        ...
        try:
            from clear_trace.interceptors.crewai import install_crewai_record_patches
