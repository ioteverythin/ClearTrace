...
from clear_trace._types import EventType, Trace, TraceEvent
from clear_trace.cassette import CassetteMismatchError, load_cassette
...
class Replayer:
    ...
    def _try_patch_openai(self) -> None:
        ...
        try:
            ...
            from clear_trace.recorder import _Patch
            ...
            def patched_create(self_inner: Any, *args: Any, **kwargs: Any) -> Any:
                ...
                if is_streaming:
                    from clear_trace.streaming import StreamReplay
    ...
    def _try_patch_openai_async(self) -> None:
        ...
        try:
            ...
            async def patched_create(self_inner: Any, *args: Any, **kwargs: Any) -> Any:
                ...
                if is_streaming:
                    from clear_trace.streaming import AsyncStreamReplay
    ...
    def _try_patch_langchain(self) -> None:
        ...
        try:
            from clear_trace.interceptors.langchain import install_langchain_replay_patches
    ...
    def _try_patch_langgraph(self) -> None:
        ...
        try:
            from clear_trace.interceptors.langgraph import install_langgraph_replay_patches
    ...
    def _try_patch_crewai(self) -> None:
        ...
        try:
            from clear_trace.interceptors.crewai import install_crewai_replay_patches
